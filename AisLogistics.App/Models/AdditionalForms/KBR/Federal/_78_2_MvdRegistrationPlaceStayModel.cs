...
public sealed class _78_2_MvdRegistrationPlaceStayModel : AbstractAdditionalFormModel
{
    public _78_2_MvdRegistrationPlaceStayModel()
    {
    ...
    /// <summary>
    /// арегистрировать по месту пребывания С
    /// </summary>
    [DisplayName("С")]
    public string DateWith { get; set; }

    /// <summary>
    /// арегистрировать по месту пребывания По
    /// </summary>
    [DisplayName("По")]
    ...
    /// </summary>
    [DisplayName("способ получения свидетельства")]
    public string MethodObtaining { get; set; }
