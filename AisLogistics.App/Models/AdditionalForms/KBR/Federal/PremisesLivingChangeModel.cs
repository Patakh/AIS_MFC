...
/// </summary>
public class PremisesLivingChangeModel
{
    /// <summary>
    /// Тип заявителя
    /// 1 - Физическое лицо
    ...
    /// <summary>
    /// Тип перевода
    /// 1 - жилое помещение в нежилое
    /// 2 - нежилое помещение в жилое
    /// </summary>
    public int ChangingTypeId { get; set; }

    /// <summary>
    /// Перевод на основании
    /// 1 - право собственности
    /// 2 - договор найма
    /// </summary>
    public int ChangingReasonTypeId { get; set; }
