...
public class AllowanceBirthUpbringingChildrenModel : AbstractAdditionalFormModel
{
   
    public AllowanceBirthUpbringingChildrenModel()
    {
    ...
    public class ApplicantType
    {
        ...
        public string NameMedicalOrganization { get; set; }
