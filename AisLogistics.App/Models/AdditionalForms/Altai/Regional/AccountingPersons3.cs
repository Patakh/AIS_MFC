...
{
    /// <summary>
    /// Внесение  в сведения, содержащиеся в списке, по заявлению физического лица
    /// </summary>
    public class AccountingPersons3 : AbstractAdditionalFormModel
    {
        public AccountingPersons3()
        {
            FamilyList = new[]{
                new Family()
            };
