...
{
    public class DataServicesRepository : GenericRepository<DocumentModelDto>, ISDocumentsRepository
    {
        public DataServicesRepository(IMapper mapper, AisLogisticsContext context, ILogger logger) : base(context, logger)
        {

        }

        public override async Task<IQueryable<DocumentModelDto>> All()
        {
        ...
        public override async Task<bool> Upsert(DocumentModelDto entity)
        {
            try
            {
